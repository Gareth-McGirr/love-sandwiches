...
def validate_data(values):
    ...
    or if there isn't exacly 6 values.
    """
    try:
...
def update_surplus_worksheet(data):
    """
    Update suprplus worksheet, add new row with the list data provided
    """
...
def calculate_surplus_data(sales_row):
    ...
    - negative surplus indictes extra made when stock was sold out.
    """
